...
export function Work() {
  return (
    <div className="flex flex-col gap-16 md:gap-24">
      ...
      >
        <Link href="https://kcftech.com" className={linkClassName}>
          <Section heading="2021 - Today" alignment="left">
            <div className="flex flex-col gap-6">
              ...
              <p>
                ...
                for issue resolution, hardware installation, and
                troubleshooting.
              </p>
              <p>
                ...
                implemented an issue management system to streamline workflows
                and foster collaboration that is now a core offering of the
                software. I also helped develop a unified design system to
                maintain consistency and efficiency across all applications.
              </p>
        ...
        <Link href="https://www.volvotrucks.us" className={linkClassName}>
          <Section heading="2021 - 2021" alignment="left">
            <div className="flex flex-col gap-6">
              ...
              <p>
                Developed an automated solution to streamline the conversion of
                2D schematics into 3D CAD models in{' '}
                ...
                helped reduce manual effort and enhanced productivity, leading
                to its adoption by Volvo&apos;s internal teams.
              </p>
              <div className="flex flex-wrap gap-3 text-sm">
        ...
        <Link href="https://themuleapp.com" className={linkClassName}>
        ...
        <Link href="https://blockchainpsu.com" className={linkClassName}>
          <Section heading="2018 - 2021" alignment="left">
            <div className="flex flex-col gap-6">
              ...
              <p>
                ...
                members, fostering FinTech and blockchain skills through
                hands-on projects and strategic initiatives. Spearheaded
                partnerships, taught an official blockchain course, and
                established a vibrant blockchain community at{' '}
